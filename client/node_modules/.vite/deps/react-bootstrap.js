...
} from "./chunk-UD4HC72F.js";
import {
  NavLink_default,
  TabContext_default,
  useNavItem
} from "./chunk-O6TG5YWY.js";
import {
  NavbarBrand_default,
...
import {
  ...
  Accordion_default,
  useAccordionButton
} from "./chunk-GDFJA62P.js";
import {
  Collapse_default,
  createChainedFunction_default
} from "./chunk-6H274XQJ.js";
import {
  CarouselCaption_default,
  CarouselItem_default,
  Carousel_default,
  useTimeout
} from "./chunk-I2MFJT55.js";
import {
  Anchor_default
} from "./chunk-7EG3A5FV.js";
import {
  useCallbackRef
} from "./chunk-QECSQBWY.js";
import "./chunk-TQD55L6O.js";
import {
  useEventCallback,
  useIsomorphicEffect_default
} from "./chunk-N3HLCMDG.js";
import {
  ENTERING,
  EXITING,
  safeFindDOMNode
} from "./chunk-FMLZTP4J.js";
import {
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-NDCSJFOC.js";
import {
  listen_default,
  ownerDocument
...
var ButtonGroup = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime8.jsx)(Component2, {
    ...
    ref,
    role,
    className: (0, import_classnames7.default)(className, baseClass, size && `${prefix}-${size}`)
  });
});
...
var Overlay = React29.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react4.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react5.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React35.forwardRef(({
  ...
  const popperRef = (0, import_react6.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react6.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react7.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react7.useRef)("");
  ...
  const handleHide = (0, import_react7.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react7.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react7.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react7.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react7.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react7.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime40.jsxs)(import_jsx_runtime39.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react7.cloneElement)(children, triggerProps), (0, import_jsx_runtime38.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime43.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames34.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames35.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var ProgressBar = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime46.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react8.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Spinner = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime49.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames39.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react9.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react10.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react10.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React56.forwardRef(({
  ...
  const context = (0, import_react11.useContext)(ToastContext_default);
...
var Toast = React58.forwardRef(({
  ...
  const delayRef = (0, import_react12.useRef)(delay);
  const onCloseRef = (0, import_react12.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react12.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react12.useMemo)(() => ({
    onClose
  }), [onClose]);
